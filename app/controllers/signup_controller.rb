...
class SignupController < ApplicationController
  ...
  def phone_number
    if verify_recaptya and user_params[:nickname].present? and user_params[:email].present? and user_params[:last_name].present? and user_params[:first_name].present? and user_params[:last_name_kana].present? and user_params[:first_name_kana].present? and birthday_join
