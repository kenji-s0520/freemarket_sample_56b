...
# レディース
lady = ExhibitCategory.create(name: "レディース")
...
# メンズ
men = ExhibitCategory.create(name: "メンズ")
...
# ベビー・キッズ
baby_kids = ExhibitCategory.create(name: "ベビー・キッズ")
...
# インテリア・住まい・小物
interior_residence_accessory = ExhibitCategory.create(name: "インテリア・住まい・小物")
...
# 本・音楽・ゲーム
book_music_game = ExhibitCategory.create(name: "本・音楽・ゲーム")
...
# おもちゃ・ホビー・グッズ
toy_hobby_goods = ExhibitCategory.create(name: "おもちゃ・ホビー・グッズ")
...
# コスメ・香水・美容
cosme_perfume_beauty = ExhibitCategory.create(name: "コスメ・香水・美容")
...
# 家電・スマホ・カメラ
appliance_smartphone_camera = ExhibitCategory.create(name: "家電・スマホ・カメラ")
...
# スポーツ・レジャー
sport_leisure = ExhibitCategory.create(name: "スポーツ・レジャー")
...
# ハンドメイド
handmade = ExhibitCategory.create(name: "ハンドメイド")
...
# チケット
ticket = ExhibitCategory.create(name: "チケット")
...
# 自動車・オートバイ
car_motorcycle = ExhibitCategory.create(name: "自動車・オートバイ")
...
# その他
others = ExhibitCategory.create(name: "その他")
